...
<body>
    ...
    <span id="theme-toggle-label" class="theme-toggle-label">Switch to Dark Mode</span>
    <button id="theme-toggle-btn" aria-label="Toggle dark mode">
        ...
        <svg id="moon-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9c.83 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.01-.23-.26-.38-.61-.38-.99 0-.83.67-1.5 1.5-1.5H16c2.76 0 5-2.24 5-5 0-4.42-4.03-8-9-8zm-5.5 9c0-3.03 2.47-5.5 5.5-5.5.08 0 .16 0 .24.01C9.6 6.8 8 8.74 8 11c0 2.21 1.79 4 4 4 .24 0 .48-.02.71-.05.02.16.04.33.04.5 0 3.03-2.47 5.5-5.5 5.5S6.5 15.03 6.5 12z"/></svg>
    </button>
    </div>
